...
HD_PWD='C:/Users/HP/Desktop/Basys3-Undertale/FinalProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log manageScene.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source manageScene.tcl -notrace
