...
HD_PWD='C:/Users/pooml/Desktop/Basys3-Undertale/FinalProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log manageScene.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source manageScene.tcl
